import {BiGridAlt, BiSearch, BiSupport} from 'react-icons/bi'
    ...
    <div className="cards-container">
      ...
      <div className="details-container">
        ...
        <ul className="people-item-container">
          <li>
            <img
              src="https://res.cloudinary.com/dunnzyptg/image/upload/v1649819900/Tasty-Kitchen/mobile-image-app_rdznaq.png"
              alt="work mobile"
              className="mobile-work-image"
            />
          </li>
      ...
      <div className="statics-container">
        <div className="icons-continer">
          <div className="icons-card">
            <BiSearch className="static-icon" />
          </div>

          <div className="icons-card">
            <VscBellDot className="static-icon" />
          </div>
        </div>
        <div className="static-indicator-container">
          ...
          <div className="time-log-card">
            <div className="log-container">
              ...
              <p className="increase-title">
                +32%{' '}
                <span>
                  <BsArrowUpShort className="up-arrow-icon" />
                </span>
              </p>
            </div>
          </div>
